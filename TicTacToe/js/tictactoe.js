...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayer is equals to 'X', the x.png is placed in HTML.
...
//This function parses the selectedSquares arrray to search for win conditions.
...
function checkWinConditions() {
    ...
    // O 6, 4, 2 condition.
    else if (arrayIncludes('2O', '50', '8O')) { drawWinLine(508, 50, 508, 558) }
    // O 6, 4, 2 condition.
